...
export const CONTACT = {
  ...
  address: '22 Grant Road, Puramahoi, Takaka 7182, Golden Bay, Nelson Tasman, top of the South Island, New Zealand',
};
...
export const WEATHER_STATION_URL = 'https://gbweather.helioho.st/FreshWDL/FreshWDL2.html';
